...
var foosResource = schema.GroupVersionResource{Group: "r2d4.com", Version: "v1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "r2d4.com", Version: "v1", Kind: "Foo"}

// Get takes name of the foo, and returns the corresponding foo object, and an error if there is any.
func (c *FakeFoos) Get(name string, options v1.GetOptions) (result *r2d4_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(foosResource, c.ns, name), &r2d4_com_v1.Foo{})
...
func (c *FakeFoos) List(opts v1.ListOptions) (result *r2d4_com_v1.FooList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(foosResource, foosKind, c.ns, opts), &r2d4_com_v1.FooList{})
	...
	list := &r2d4_com_v1.FooList{}
	for _, item := range obj.(*r2d4_com_v1.FooList).Items {
...
func (c *FakeFoos) Create(foo *r2d4_com_v1.Foo) (result *r2d4_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(foosResource, c.ns, foo), &r2d4_com_v1.Foo{})
...
func (c *FakeFoos) Update(foo *r2d4_com_v1.Foo) (result *r2d4_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(foosResource, c.ns, foo), &r2d4_com_v1.Foo{})
...
func (c *FakeFoos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(foosResource, c.ns, name), &r2d4_com_v1.Foo{})
...
func (c *FakeFoos) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &r2d4_com_v1.FooList{})
	return err
}

// Patch applies the patch and returns the patched foo.
func (c *FakeFoos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *r2d4_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(foosResource, c.ns, name, data, subresources...), &r2d4_com_v1.Foo{})
